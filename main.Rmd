...
Mit dem Welch's t-Test möchten wir untersuchen ob jeweils 2 Stichproben einen gemeinsamen Mittelwert haben. Dieser Test ist eine Erweiterung des Student's t-Test welcher aber vertraunswürdiger sein soll bei ungleichen Varianzen und unterschiedlichen Stichprobengrössen [@welch].
...
Sämtliche Tests führen auf keinen signifikanten Unterschied der verschiedenen Stichprobenmittelwerte. Beim betrachten der Stichprobenmittelwerte und Standardabweichungen in \ref{fig:results} macht dies durchaus Sinn, die Intervalle überschneiden sich. Lediglich die p-Werte der CM-Gruppe für die Squats weisen im vorher-nachher-Vergleich zu einem 10%-igen Niveau einen Effekt auf, siehe Tabelle \ref{tab:squattable1}.
...
Gehe man davon aus, dass die 28 fehlenden Werte alle aus der CHO-Gruppe stammen. Alle 28 wären Football-Spieler einer Mannschaft mit einem mttlerem Körpergewicht von 90kg und einer Standardabweichung von 4kg. Der Vorher-Mittelwert mit $n_{2}=52$ von $76.8\pm19.8$ würde sich qualitativ durch das hinzufügen der 28 Footballspieler beispielsweise auf $n_{2}=80$ mit $81\pm17.9$ verändern. So eine Veränderung der Stichprobe hätten einen Einfluss auf die Resultate und würde diese verzerren.

### Vergleich zu andere proteinhaltige Getränke

Einnahme von Protein hat einen klaren Einfluss auf den Muskelaufbau [@protein]. Getestet wurde eine proteinhaltige Schokoladenmilch gegen ein proteinfreies Sportgetränk, die Nährstoffe sind in Abbildung \ref{fig:makro} ersichtlich. Wie sähe die Studie aus, wenn man zusätzlich ein anderes proteinhaltiges Sportgetränk mitgetestet hätte? Die Studie wurde von Milchprodukt-Vertreten finanziert. Möglicherweise war dies nicht in deren Interesse, da sie den Effekt anhand von einem Milchprodukt testen wollten und einen möglichst grossen Unterschied in den Produkten sehen wollten.
...
Eine Erweiterung der Studie mit einer Placebo-Versuchsgruppe wäre interessant gewesen.
